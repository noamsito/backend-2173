...
API_GATEWAY_ID="c50kleawcc"  # CAMBIAR POR TU ID REAL
...
GENERATE_BOLETA_FUNCTION_ARN="arn:aws:lambda:us-east-1:ACCOUNT-ID:function:boletas-pdf-grupo1-dev-generateBoleta"
GET_BOLETA_STATUS_FUNCTION_ARN="arn:aws:lambda:us-east-1:ACCOUNT-ID:function:boletas-pdf-grupo1-dev-getBoletaStatus"
HEALTH_CHECK_FUNCTION_ARN="arn:aws:lambda:us-east-1:ACCOUNT-ID:function:boletas-pdf-grupo1-dev-healthCheck"
